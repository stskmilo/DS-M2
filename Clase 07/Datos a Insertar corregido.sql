...
INSERT instructor (cedula, nombre, apellido, fecha_nac, fecha_inc) 
...
DELETE FROM instructor WHERE id_instructor > 8;

#Se insertan valores en la tabla cohortes.
INSERT INTO cohorte (id_cohorte, codigo, id_carrera, id_instructor, fecha_inicio, fecha_fin)
...
SELECT * FROM cohorte;
DELETE FROM cohorte WHERE id_cohorte > 1235;
...
INSERT INTO alumno (id_alumno,cedula,nombre,apellido,fecha_nac,fecha_ing,id_cohorte)
